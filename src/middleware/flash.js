...
const flashMiddleware = (req, res, next) => {
    req.flash = function(type, message) {
        ...
        // SETTING: Two arguments means storing a message
        if (type && message) {
        ...
        // GETTING ONE TYPE: One argument retrieves messages of that type
        if (type && !message) {
        ...
        // GETTING ALL: No arguments retrieves all messages
